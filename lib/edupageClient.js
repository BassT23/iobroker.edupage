  ...
  async warmUpTimetable() {
    ...
    if (!ok) {
      this.log.warn(
        ...
        'Next step: we may need to follow a post-login redirect/landing page to trigger edusrs.'
      );
    }
  }
